...
export const gridItems = [
  {
    id: 1,
    title: "",
    description: "I prioritize collaborative partnerships with clients, fostering transparent communication to ensure alignment and drive successful outcomes. ",
  ...
  {
    id: 2,
    title: "I am highly flexible with communication across different time zones.",
    description: "",
  ...
  },
  {
    id: 3,
    title: "My tech stack",
    description: "I am dedicated to constant improvement",
    className: "lg:col-span-2 bg-gray-500 md:col-span-3 md:row-span-2",
    imgClassName: "",
  ...
  {
    id: 4,
    title: "Driven by innovation and a love for tech development.",
    description: "",
